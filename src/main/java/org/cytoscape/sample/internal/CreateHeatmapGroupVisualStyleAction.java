...
public class CreateHeatmapGroupVisualStyleAction extends AbstractCyAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		while (it.hasNext()){
			...
			if (curVS.getTitle().equalsIgnoreCase("KEGG Heatmap Homology Style"))
			{
		...
		VisualStyle vs= this.visualStyleFactoryServiceRef.createVisualStyle("KEGG Heatmap Homology Style");
		...
		CyColumn groupColumn = nodeTable.getColumn("Homology Cluster");
 		...
 		groupStorage = groupColumn.getValues(Integer.class);
